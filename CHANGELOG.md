...
### Fixed
- [Lines](https://chird.github.io/meteoJS/doc/module-meteoJS_thermodynamicDiagram.html#~lineOptions) set to invisible aren't drawn anymore in the thermodynamic diagram.
